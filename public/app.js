...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    return function(modules) {
        ...
        (function(glob) {
            ...
            typeof module != "undefined" && module.exports ? module.exports = eve : true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], 
...
JustGage = function(config) {
    ...
    obj.config = {
        ...
        shadowOpacity: kvLookup("shadowOpacity", config, dataset, .2),
    ...
    canvasW, canvasH, widgetW, widgetH, aspect, dx, dy, titleFontSize, titleX, titleY, 
    valueFontSize, valueX, valueY, labelFontSize, labelX, labelY, minFontSize, minX, 
    minY, maxFontSize, maxX, maxY = null;
    ...
    if (ie !== "undefined" && ie < 9) {} else if (ie !== "undefined") {
...
function createLoudMeter(options) {
    ...
    gauge = new JustGage({
        ...
        gaugeColor: "#f4f4f4",
        gaugeWidthScale: .7,
        levelColors: [ "#fa4133", "#fdbe37", "#1cb42f" ]
    });
}
...
function onAudioMeasureStart(stream) {
    ...
    meter = createAudioMeter(audioContext, .999);
...
function getResultMessageHtml(message, image) {
    return [ '<div class="feedback-message">', message, "</div>", '<img src="' + image + '"/>' ].join("");
}
...
function createAudioMeter(audioContext, clipLevel, averaging, clipLag) {
    ...
    processor.volume = 0;
    processor.clipLevel = clipLevel || .98;
    processor.averaging = averaging || .95;
